 ...
 *   npx tsx scripts/generate-cat-content.ts --theme "food"
 *   npx tsx scripts/generate-cat-content.ts --skip-video
 */
...
async function main() {
  ...
  console.log('🐱 Cat Interview Content Generator\n');
  ...
  try {
    const result = await runInterviewPipeline('cat_interview', {
      theme,
